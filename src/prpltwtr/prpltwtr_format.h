...
typedef GList *(*TwitterFormatListAndCountFromChildNodeListFunc)(gpointer node, GList *list, gint * count);
...
typedef struct {
	...
	TwitterFormatListAndCountFromChildNodeListFunc copy_into;
